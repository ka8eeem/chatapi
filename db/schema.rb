...
ActiveRecord::Schema.define(version: 2022_10_02_164721) do
  ...
  create_table "chats", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["chat_number", "applications_id"], name: "index_chats_on_chat_number_and_applications_id", unique: true
  end
  ...
  create_table "messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["message_number", "chats_id"], name: "index_messages_on_message_number_and_chats_id", unique: true
  end
